          ...
          <div className="col-lg-6 offset-lg-3 col-md-12 col-sm-12 ">
            <div className="title_default_light title_border text-center">
              ...
              <p
                ...
                data-animation-delay="0.2s"
              >
                ;sdhfskjskdjsllksdkhlgjldhgsgslk ldsgskjilj k.hfwsefslkhjisdfs
                klhsdsedklsdfojsdlih lkhsdfdsukfjsl
              </p>
            </div>
          </div>
        </div>
        ...
        <div className="row align-items-center ">
            ...
            <div className="token_sale res_md_mb_40 res_md_mt_40 res_sm_mb_30 res_sm_mt_30 ">
              ...
              >
                ...
                <div className="tk_counter_inner">
                  ...
                  >
                    <div
                      className="progreass-bar  progress-bar-striped gradient"
                      role="progressbar"
                    ...
                    <span className="progress_label bg-white inline_style_1">
                      <strong>{tokenSale?.tokenSold}PDC</strong>
                    </span>
                    <span className="progress_label bg-white inline_style_2">
                      <strong>{tokenSale?.tokenSaleBalance}PDC</strong>
                    </span>
          ...
          <div className="col-lg-3">
            ...
            <div className="pr_box">
              ...
              >
                {" "}
                {tokenSale?.tokenSold} PDC {showPercentage?.slice(0, 4)} %{" "}
              </p>
            </div>
